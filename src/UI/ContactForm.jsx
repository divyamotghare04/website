...
const ContactUsForm = () => {
  ...
  return (
    <div className="zf-templateWidth">
      <form
        action="https://forms.zohopublic.com/dataweaver/form/ContactUs/formperma/XXCr7fKP3uzXC1h023lcrIuTM3wL2ZnHO0AiYHxsaVQ/htmlRecords/submit"
        name="form"
        method="POST"
          ...
          <div className="zf-subContWrap zf-topAlign">
            <ul>
              ...
              <li className="zf-tempFrmWrapper zf-small">
                <label className="zf-labelName">Company Name</label>
