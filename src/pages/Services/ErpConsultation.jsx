...
function ErpConsultation() {
  ...
  return (
    <div>
      ...
      <div className="mt-[9.8125rem] flex items-start justify-between mx-16 mb-10 reveal">
        <div>
      ...
      <div className="flex xl:p-20 xl:m-10 lg:p-16 items-center justify-between reveal">
      ...
      <div className="flex text-center reveal">
      ...
      <div className="flex xl:mx-20 xl:px-8 lg:mx-5 items-center mb-6 reveal">
